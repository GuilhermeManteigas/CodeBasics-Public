...
ace.define("ace/mode/codebasics/jshint",[], function(require, exports, module) {
...
var JSHINT = (function() {
  ...
  infix("+", function(context, left, that) {
    ...
    if (left && right && left.id === "(string)" && right.id === "(string)") {
      ...
      if (!state.option.scripturl && reg.codebasicsURL.test(left.value)) {
        warning("W050", left);
      }
      return left;
    }
...
var warnings = {
  ...
  W118: "'{a}' is only available in Mozilla codebasics extensions (use moz option).",
  ...
  W129: "'{a}' is defined in a future version of codebasics. Use a " +
...
exports.codebasicsURL = /^(?:codebasics|jscript|ecmascript|vbscript|livescript)\s*:/i;
...
exports.register = function(linter) {
  ...
  linter.on("String", function style_scancodebasicsURLs(data) {
    var re = /^(?:codebasics|jscript|ecmascript|vbscript|livescript)\s*:/i;
...
ace.define("ace/mode/codebasics_worker",[], function(require, exports, module) {
"use strict";

var oop = require("../lib/oop");
var Mirror = require("../worker/mirror").Mirror;
var lint = require("./codebasics/jshint").JSHINT;
...
var codebasicsWorker = exports.codebasicsWorker = function(sender) {
    Mirror.call(this, sender);
    this.setTimeout(500);
    this.setOptions();
};

oop.inherits(codebasicsWorker, Mirror);
...
}).call(codebasicsWorker.prototype);
